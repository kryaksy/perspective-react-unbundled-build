# PerspectiveReactUnbundledBuild
...
```sh
npx nx serve perspective-react-unbundled-build
```

To create a production bundle:

```sh
npx nx build perspective-react-unbundled-build
```

To see all available targets to run for a project, run:

```sh
npx nx show project perspective-react-unbundled-build
```
